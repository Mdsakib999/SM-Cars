...
const Benefits = () => {
  return (
    <section className=" lg:max-w-[98%]  mx-auto my-12 py-4 rounded-lg">
      ...
      <div className="flex flex-col lg:flex-row justify-between text-center lg:text-start gap-4">
        <div>
          ...
          <TbZoomMoney className="text-4xl my-4 text-orange-400 mx-auto lg:mx-0" />
        </div>
        <div>
          <h4 className="text-lg pb-4">Trusted Car Dealership</h4>
          <p className="text-gray-800">
          ...
          <LiaMoneyCheckSolid className="text-4xl my-4 text-orange-400 mx-auto lg:mx-0" />
        </div>
        <div>
          <h4 className="text-lg pb-4">Trusted Car Dealership</h4>
          <p className="text-gray-800">
